...
enum Scene { HOUSE, CITY, SAVE, LIBRARY, TOWER, MARKET, UNIVERSITY, JOURNAL, AIRSHIP, CREDITS, ALEMBIC, HIVE}
...
func _update_visibility():
	...
	get_tree().call_group("HiveFrame", "hide")
	...
	match current_scene:
		...
		Scene.HIVE:
			get_tree().call_group("HiveFrame", "show")
